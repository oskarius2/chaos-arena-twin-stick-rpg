...
const defs: ArtDef[] = [
  ...
  { id: 'needle_driver', name: 'Needle Driver', description: 'Damage +35', rarity: BuffRarity.COMMON, slot: 'CANNON_C', stats: { damageMod: 35 } },
  { id: 'phase_lance', name: 'Phase Lance', description: 'Damage +80', rarity: BuffRarity.COMMON, slot: 'CANNON_C', stats: { damageMod: 80 } },
  { id: 'antimatter_line', name: 'Antimatter Line', description: 'Damage +200%', rarity: BuffRarity.RARE, slot: 'CANNON_C', stats: { damageMod: 3 } },
  { id: 'starbreaker', name: 'Starbreaker', description: 'Damage +250, Crit +8%', rarity: BuffRarity.EPIC, slot: 'CANNON_C', stats: { damageMod: 250, critMod: 0.08 } },
  { id: 'event_horizon_c', name: 'Event Horizon C', description: 'Damage +350%, Energy +40', rarity: BuffRarity.LEGENDARY, slot: 'CANNON_C', stats: { damageMod: 4.5, energyMod: 40 } },
  ...
  { id: 'doom_splicer', name: 'Doom Splicer', description: 'Damage +500, Speed -15%', rarity: BuffRarity.LEGENDARY, slot: 'CANNON_C', stats: { damageMod: 500, speedMod: 0.85 } },
];
...
export const ALL_ARTIFACT_SLOTS: ArtifactSlot[] = ['CANNON_A', 'CANNON_B', 'CANNON_C', 'ARMOR', 'MOBILITY'];
